...
def summarize_results(results: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "avg_candidates": _avg(results, "candidate_count"),
        "avg_curated_evidence": _avg(results, "curated_evidence_count"),
        "avg_verifications": _avg(results, "verification_count"),
        "avg_pruned_candidates": _avg(results, "pruned_candidate_count"),
